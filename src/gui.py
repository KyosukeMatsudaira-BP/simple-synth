...
class SynthGUI(tk.Tk):
    ...
    def reset_to_sine(self):
        ...
        self.poly_synth.set_attack(0.00)
        self.poly_synth.set_decay(0.0)
        self.poly_synth.set_sustain(1.0)
        self.poly_synth.set_release(0.0)
        ...
        self.attack_var.set(0.00)
        self.decay_var.set(0.0)
        self.sustain_var.set(1.0)
        self.release_var.set(0.0)
